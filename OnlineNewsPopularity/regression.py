...
def __dummy_train(X_train, Y_train, X_target, Y_target):
	...
	svc = LinearSVR(verbose=2, max_iter=500)
...
def main():
	...
	files = ['../twitter_datasets/Trump_0.csv', '../twitter_datasets/Trump_1.csv', '../twitter_datasets/Trump_2.csv', 
			'../twitter_datasets/Trump_3.csv','../twitter_datasets/Trump_4.csv']
	...
	'''
	X_source, X_aux_list, X_target = transform_samples_otda(X_source, Y_source, X_aux_list, Y_aux_list, X_target, Y_target)
